  ...
  ***************************************************************************** */
  ...
  var ProvenanceSlidedeckPlayer = /** @class */ (function () {
      function ProvenanceSlidedeckPlayer(slides, selectCallback) {
          ...
          this._status = exports.STATUS.IDLE;
      }
                  ...
                  switch (_a.label) {
                      case 0:
                          shouldPlayNext = function () {
                              return _this._status === exports.STATUS.PLAYING && _this._currentSlideIndex < _this._slides.length - 1;
                          };
                          if (!(this._status === exports.STATUS.IDLE)) return [3 /*break*/, 4];
                          this._status = exports.STATUS.PLAYING;
  ...
  exports.ProvenanceSlidedeckPlayer = ProvenanceSlidedeckPlayer;
...
//# sourceMappingURL=provenance-core.umd.js.map
